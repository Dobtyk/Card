        ...
        public class Straight : ICombinationAnalyzer
        {
            ...
            public bool Check(IReadOnlyList<SlotCard> hand)
            {
                if (hand.Count < 5)
                    return false;
                var sortedHand = hand.OrderBy(c => c.CardValue).ToArray();
                if ((sortedHand[0].CardValue == CardValueType.Two && sortedHand[1].CardValue == CardValueType.Three && sortedHand[2].CardValue == CardValueType.Four && sortedHand[3].CardValue == CardValueType.Five && sortedHand[4].CardValue == CardValueType.Ace) || ((int)sortedHand[0].CardValue == (int)sortedHand[1].CardValue - 1 && (int)sortedHand[1].CardValue == (int)sortedHand[2].CardValue - 1 && (int)sortedHand[2].CardValue == (int)sortedHand[3].CardValue - 1 && (int)sortedHand[3].CardValue == (int)sortedHand[4].CardValue - 1))
                    return true;
                return false;
            }
        }
